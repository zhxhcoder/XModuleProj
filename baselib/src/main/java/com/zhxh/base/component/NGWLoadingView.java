...
import com.zhxh.base.utils.DisplayUtils;
...
public class NGWLoadingView extends View {
    ...
    public NGWLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.NGWLoadingView, defStyleAttr, 0);
        mSize = array.getDimensionPixelSize(R.styleable.NGWLoadingView_ngw_loading_view_size, DisplayUtils.dp2px(40));
        mPaintColor = array.getInt(R.styleable.NGWLoadingView_android_color, Color.WHITE);
        progressStyle = array.getInt(R.styleable.NGWLoadingView_ngw_loading_progress_style, PROGRESS);
        array.recycle();
        initPaint();
    }
